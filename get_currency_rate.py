...
if __name__=="__main__":
    ...
    connection, cursor = connect_to_db(db_host, db_user, db_password, db_name, db_port) # получили подключение к БД
